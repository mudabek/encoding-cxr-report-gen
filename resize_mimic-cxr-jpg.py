...
def main(args):
    ...
    in_files = os.path.join(args.jpgs, 'images_clean/files')
    resized_dir = os.path.join(os.path.dirname(args.jpgs), '..', 'mimic-cxr-resized')
    # resized_dir = os.path.dirname('/l/users/20020038/mimic-cxr-resized')
    ...
    if not os.path.exists(resized_dir):
        ...
        os.mkdir(out_files)
        for item in os.listdir(os.path.join(args.jpgs, '')):
    ...
    shutil.copy(os.path.join(args.jpgs, 'mimic-cxr-2.0.0-chexpert.csv'), os.path.join(resized_dir, '2.0.0'))
    shutil.copy(os.path.join(args.jpgs, 'mimic-cxr-2.0.0-metadata.csv'), os.path.join(resized_dir, '2.0.0'))
    shutil.copy(os.path.join(args.jpgs, 'mimic-cxr-2.0.0-split.csv'), os.path.join(resized_dir, '2.0.0'))
    # Resize images
